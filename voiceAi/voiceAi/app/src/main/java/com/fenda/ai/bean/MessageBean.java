...
public class MessageBean{
    ...
    public static final int TYPE_WIDGET_WEATHER = 6;//custom widget 3
    ...
    public void setKeepSingle(boolean keepSingle) {
        isKeepSingle = keepSingle;
    }
}
